...
technology = ["technology", "phone", "wire", "transistor", "gate", "electromagnetic", "signal", "antenna", "display"]
...
math = ["math", "division", "subtraction", "addition", "multiplication", "fraction", "algebra", "calculus", "equation"]
